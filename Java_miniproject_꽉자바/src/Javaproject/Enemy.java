...
public class Enemy {
	...
	public Enemy getEnemyLand(String id) {
		...
		eList.add(new Enemy("여우", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("족제비", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("반달가슴곰", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("엘크", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("맷돼지", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("뱀", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("도마뱀", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("나무늘보", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("코알라", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("캥거루", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("아프리카코끼리", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("호랑이", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("사자", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("치타", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("표범", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("얼룩말", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
		eList.add(new Enemy("하이에나", randomCalHp(z, a), randomCal(t, b), randomCal(t, c), randomCal(t, d), randomCal(st.getStr(), e), randomCal(t, f), randomCal(t, g), randomCal(t, 1)));
